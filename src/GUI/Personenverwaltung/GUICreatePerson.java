...
public class GUICreatePerson {
    ...
    public static void display() {
		...
		GridPane.setConstraints(passwortLabel, 0, 8);
		
		PasswordField passwortInput = new PasswordField();
		GridPane.setConstraints(passwortInput, 1, 8);
		
		Label passwortconfirmLabel = new Label("Passwort bestaetigen: ");
		GridPane.setConstraints(passwortconfirmLabel, 0, 9);
		
		PasswordField passwortconfirmInput = new PasswordField();
		GridPane.setConstraints(passwortconfirmInput, 1, 9);
		
		Button btnErstellen = new Button("Erstellen");
		GridPane.setConstraints(btnErstellen, 1, 10);
		
		Button btnClose = new Button ("Schliessen");
		GridPane.setConstraints(btnClose, 1, 10,1,1,HPos.RIGHT,null);
